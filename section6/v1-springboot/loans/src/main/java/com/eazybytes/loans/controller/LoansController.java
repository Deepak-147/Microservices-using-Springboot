...
/**
 * Author: ldeepak
 * LoansController is a REST controller that handles HTTP requests related to loans.
 * It provides endpoints for creating, fetching, updating, and deleting loans.
 */
@Tag(
		name = "Loans API",
