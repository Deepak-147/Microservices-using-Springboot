 ...
 * @RefreshScope allows the controller to refresh its configuration properties at runtime without restarting the application. This is particularly useful when using Spring Cloud Config to manage externalized configuration.
